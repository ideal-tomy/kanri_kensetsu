...
INSERT INTO tasks (site_id, title, unit, planned_qty, actual_qty, status, progress_pct, created_by) VALUES
  ((SELECT id FROM sites WHERE name='A邸新築'),
...
FROM this_monday m, (
  VALUES
    ('田中太郎', 'A邸新築',     'day_full',   0),
    ('田中太郎', 'A邸新築',     'day_full',   1),
    ('田中太郎', 'A邸新築',     'day_full',   3),
    ('田中太郎', 'A邸新築',     'day_full',   4),
    ('佐藤次郎', 'A邸新築',     'day_full',   0),
    ('佐藤次郎', 'A邸新築',     'day_full',   1),
    ('佐藤次郎', 'A邸新築',     'day_full',   3),
    ('鈴木三郎', 'Bビル改修',   'night_full', 0),
    ('鈴木三郎', 'Bビル改修',   'night_full', 1),
    ('鈴木三郎', 'Bビル改修',   'night_full', 2),
    ('鈴木三郎', 'Bビル改修',   'night_full', 4),
    ('鈴木三郎', 'Bビル改修',   'night_full', 5),
    ('山田社長', 'Cマンション', 'day_full',   1),
    ('山田社長', 'Cマンション', 'day_full',   2),
    ('山田社長', 'Cマンション', 'day_full',   3),
    ('山田社長', 'Cマンション', 'day_full',   4)
