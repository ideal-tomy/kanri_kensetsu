...
export const reportPhotos: ReportPhoto[] = [
  {
    ...
    renamedFileName: `${DEMO_BRAND.companyName}_大阪現場_20260429_完了.jpg`,
  ...
  },
  {
    ...
    renamedFileName: `${DEMO_BRAND.companyName}_梅田現場_20260429_是正前.jpg`,
...
export const aiLogs: AiLog[] = [
  {
    ...
    type: "rename",
    message:
      `AIがファイル名を「${DEMO_BRAND.companyName}_大阪現場_20260429_完了.jpg」に自動変更し、Google Driveへ保存しました`,
